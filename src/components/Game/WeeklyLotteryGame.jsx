...
import WeeklyTicket from '../ticket/WeeklyTicket';

const WeeklyGame = ({ gameName, total, ticketAmount }) => {
  ...
  const generateTicket = () => {
    ...
    const storedTicketCode = localStorage.getItem('weeklyGameTicketCode');
