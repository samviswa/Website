...
const Ticket = ({ gameName, userName, selectedNumbers, ticketCode, ticketAmount, total }) => {
  ...
  const downloadTicket = async () => {
    try {
      ...
      const ticketImageRef = ref(storage, `Weekly Tickets/${ticketCode}.png`);
  ...
  return (
    <div className='w-full flex items-center justify-center mt-[100px] ' ref={ticketRef}>
      <div className='w-[800px] h-[300px] bg-gray-300 flex'>
        <div className='bg-[#DDD]  w-[600px] h-[300px]'>
          ...
          <h2 className="title text-3xl relative shadow-sm -top-[250px] ultra-regular text-center">Weekly Lottery Ticket</h2>
