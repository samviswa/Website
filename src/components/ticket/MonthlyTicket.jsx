...
const MonthlyTicket = ({ gameName, userName, selectedNumbers, ticketCode, ticketAmount, total }) => {
  ...
  const downloadTicket = async () => {
    try {
      ...
      const ticketImageRef = ref(storage, `Monthly Tickets/${ticketCode}.png`);
  ...
  return (
      <>
    <div className='tref w-full flex items-center justify-center mt-[100px] 'ref={ticketRef}>
      <div className='ticket w-[800px] h-[300px] bg-yellow-300 flex'>
        <div className='tleft bg-yellow-200 w-[600px] h-[300px]'>
          ...
          <h2 className="title text-3xl relative shadow-sm -top-[250px] ultra-regular  text-center">Monthly Lottery Ticket</h2>
          <p className="text-xl font-black relative -top-[250px] -right-[210px]">{selectedNumbers.join(' , ')}</p>
          <img src={"https://i.postimg.cc/HWc0yrj1/corner.png"} className='corner relative -top-[280px] opacity-35 -left-[35px] w-[250px] h-[250px]'/>
          <img src='https://i.postimg.cc/KvmzyW6p/topcorner.png' className='tcorner relative -right-[620px] opacity-35 -top-[650px] w-[200px] h-[200px]' />    
    ...
    <p className="archivo-black-regular"><span className="archivo-black-regular">20/4/2024</span> </p>
                <p className="archivo-black-regular"><span className="archivo-black-regular">30/4/2024</span> </p>
