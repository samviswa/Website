...
const LotteryInfo = () => {
 ...
 return (
    <div className="bg-gray-100 rounded-lg shadow-md p-5 max-w-md mx-auto">
      ...
      <div className="m-5">
        <h3 className="text-lg font-semibold m-5">How to Play Golden Box Online</h3>
        <p>To play the Golden Box lottery online, you must:</p>
        <div className="m-5">
        ...
        <p>Read our detailed guide on <a href="/" className="text-blue-500 no-underline">How to Play Golden Box online</a> or visit our <a href="/mega-millions-resource-centre" className="text-blue-500 no-underline">Golden Box Resource Centre</a> for more help with playing the Golden Box lottery online on Lotto247.</p>
      </div>
    </div>
 );
};
